...
@pustejovsky2022meta) for small-sample size adjustment. Using the
fitted BMLMA (the object `BMLMA`) as an example, the implementation of
robust variance estimation is as:
